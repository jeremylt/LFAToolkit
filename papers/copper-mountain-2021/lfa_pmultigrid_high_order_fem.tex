...
Also, we briefly described how thi work can be extended to LFA of h-multigrid for finite difference discretization stencils that can be represented as finite difference methods.
